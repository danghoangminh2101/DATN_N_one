...
function ListProduct() {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-50 px-4 py-6 md:px-8 lg:px-0 lg:w-[90%] xl:w-[80%] mx-auto">
            <div className="flex flex-col lg:flex-row gap-6">
                {/* Sidebar */}
                <div className="w-full lg:w-[20rem] h-[30rem] bg-white rounded-xl  shadow-md p-4">
                ...
                <div className="flex-1">
                    {/* Toggle View */}
                    <div className="flex gap-4 text-xl items-center justify-end mb-6">
                        <div 
