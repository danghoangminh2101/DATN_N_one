          ...
          <div className="flex flex-col w-full max-w-[930px]">
            ...
            <div className="flex flex-wrap gap-8 mt-14 justify-center text-sm font-light whitespace-nowrap text-neutral-400 max-md:mt-10 w-full">
              <input 
                type="text"
                placeholder="Name*"
                className="px-5 py-5 bg-white rounded-2xl border border-solid border-zinc-300 w-full md:w-[45%] outline-none"
              />
              <input 
                type="email"
                placeholder="Email*"
            ...
            <input 
              type="text"
              placeholder="Subject*"
              className="px-5 py-5 mt-8 text-sm font-light bg-white rounded-2xl border border-solid border-zinc-300 text-neutral-400 w-full outline-none"
            />
            <textarea 
              placeholder="Your message..."
              className="w-full px-5 py-5 mt-8 bg-white rounded-2xl border border-solid border-zinc-300 h-[250px] resize-none outline-none"
            />
