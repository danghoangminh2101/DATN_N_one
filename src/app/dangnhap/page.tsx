...
const Login = () => {
  ...
  return (
 <div>
 <div className="relative flex flex-col justify-center items-center w-full text-center bg-[#acabab] min-h-[406px] px-4 sm:px-8 md:px-20 py-12 sm:py-24 md:py-40">
