...
export default function Cart() {
  const cart: CartItem[] = useRecoilValue(cartState); 
  return (
            ...
            <tr key={item.id}>
              ...
              <td className="product-quantity flex justify-center items-center">
                <div className="flex items-center border">
                  <button className="border text-[1rem] px-1 py-1 cursor-pointer">
                    -
                  </button>
                  <input
                    type="number"
    ...
    {(item.price * item.quantity).toLocaleString()}
      ...
      <div className="flex justify-between py-[1rem]">
        ...
        <div className="flex gap-[1rem]">
          ...
          <button className="py-[.4rem] px-[1.3rem] bg-[#266bf9] text-white text-[1rem] flex justify-center items-center transition-all hover:bg-[#0055ff]">
            Clear Shopping Cart
          </button>
        </div>
      </div>
      <div className="flex justify-between">
        <div className="cart-tax w-[30%] bg-white px-[1rem] py-[2rem] text-black">
          <h4 className="font-semibold mb-[1rem] text-[1rem]">
            Estimate Shipping And Tax
          </h4>
          <p className="mb-[.8rem] text-[.9rem] text-gray-400">
          ...
          <div className="tax-select-wrapper">
            ...
            <input
              type="text"
              className="w-full border border-black py-[.3rem] px-3"
            />
            <button className="cart-btn-2 mt-[1rem]" type="submit">
              Get A Quote
            </button>
          </div>
        </div>
        ...
        <div className="cart-tax w-[30%] bg-white px-[1rem] py-[2rem] text-black">
          ...
          <h5 className="flex py-[1rem] justify-between">
            Total products <span className="font-semibold"></span>
          </h5>
          ...
          <h4 className="grand-total-title flex justify-between text-[1.1rem] py-[2rem] font-semibold text-[#266bf9]">
            Grand Total <span>1</span>
          </h4>
          <a
            href="checkout.html"
            className="block text-center bg-[#266bf9] text-white py-2 text-[.9rem]"
          >
            Proceed to Checkout
          </a>
        </div>
