  ...
  return (
    <div className="bg-white flex flex-col pb-10">
      ...
      <div className="container mx-auto mt-10" style={{ width: '100%' }}>
        <div className="flex flex-wrap justify-center gap-6" style={{ width: '80%', margin: '0 auto' }}>
          {blogPosts.map((post, index) => (
              <div className="bg-white p-4 rounded-lg w-[270px]" key={index}>
                ...
                <div className="mt-3">
                  ...
                  <Link href={`/blog/blogDetail`}>{post.title}</Link>
                  </h1>
                  <p className="mt-3 text-sm text-gray-700">
                    {post.description}
                  </p>
                  <Link
                  href={`/blog/blogDetail`} // Dẫn đến chi tiết bài viết với ID
